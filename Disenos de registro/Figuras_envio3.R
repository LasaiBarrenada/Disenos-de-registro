...
library(data.table)
setwd("M:/EIPI3/Lasai/")
data.train <- readRDS("Datos/Train3.rds")
data.control <- readRDS("Datos/Control3.rds")
data.train.dropped <- readRDS("Datos/data.train.dropped3.rds")
df_resulados <- as.data.table(readRDS("Datos/gridTrees3.rds"))
hyper_grid <- readRDS("Datos/hypergrid_envio3.rds")



pdf(file = "Imagenes/Envio3/ErrorVSnumtree3.pdf")
...
grid = as.data.table(readRDS("Datos/hypergrid_envio3.rds"))
...
pdf(file = "Imagenes/Envio3/GrandesScatter3.pdf")
...
dev.off()
pdf(file = "Imagenes/Envio3/PequeñasScatter3.pdf")
...
dev.off()
pdf(file = "Imagenes/Envio3/TotalScatterUmbral3.pdf")
...
dev.off()
pdf(file = "Imagenes/Envio3/ImputacioRFvsINEMIG.pdf")
...
pdf(file = "Imagenes/Envio3/ErrorINERF.pdf")
