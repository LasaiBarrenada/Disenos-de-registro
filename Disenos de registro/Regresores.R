...
regresores1 <- unicosRegresoresNONA[envioPID == "01"]
regresores2 <- unicosRegresoresNONA[envioPID == "02"]
regresores3 <- unicosRegresoresNONA[envioPID == "03"]

pdf(file = "Imagenes/PatronNoRespuestaOK.pdf")

aggr_plot <- aggr(regresores1, 
                  col=c('navyblue','red'), 
                  numbers=TRUE, 
                  sortVars=TRUE,
                  combined = T,
...
saveRDS(FDE, "Datos/FDE.rds")
saveRDS(regresores1, "Datos/regresores1.rds")
saveRDS(regresores2, "Datos/regresores2.rds")
saveRDS(regresores3, "Datos/regresores3.rds")
