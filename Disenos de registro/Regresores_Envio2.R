...
regresores.PGR <- envio2finalPGR[,list(NUMIDEST,CN01,CN02,CN03,CN04,CN05)]

# regresores.fde <- FDE[,list(numidest,acti,ccaa,cn01a,cn01v,cn01e)]
regresores.PID <- envio2finalPID[,list(numidest,cnaeest,`cnaeemp `,provem,proves,codddpp,codtame,actual,obsanual1,obsanual2,prioridp,resulta, envioPID)]
...
pdf(file = "Imagenes/Envio2/PatronNoRespuestaENVIO2.pdf")
...
saveRDS(unicosRegresoresNONA, "Datos/regresoresenvio2BIEN.rds")
