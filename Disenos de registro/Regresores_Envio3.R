...
regresores.PGR <- envio3finalPGR[,list(NUMIDEST,CN01,CN02,CN03,CN04,CN05)]

# regresores.fde <- FDE[,list(numidest,acti,ccaa,cn01a,cn01v,cn01e)]
regresores.PID <- envio3finalPID[,list(numidest,cnaeest,`cnaeemp `,provem,proves,codddpp,codtame,actual,obsanual1,obsanual2,prioridp,resulta, envioPID)]
...
unicosRegresoresNONA[envioPID !="03"]


pdf(file = "Imagenes/Envio3/PatronNoRespuestaENVIO3.pdf")
...
saveRDS(unicosRegresoresNONA, "Datos/regresoresenvio3BIEN.rds")
